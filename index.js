...
app.get('/shops-in-boundingbox', function(req, res) {
  ...
  */
  const options = {
    method: 'GET',
    url: "https://overpass.openstreetmap.fr/api/interpreter?data=[out:json];node[%27shop%27=%27cannabis%27](" + minLat +"," + minLon + "," + maxLat + "," + maxLon + ");out%20body;",
  };
...
app.get('/shops-in-boundingbox-delta', function(req, res) {
  ...
  const options = {
    method: 'GET',
    url: "https://overpass.openstreetmap.fr/api/interpreter?data=[out:json];node[%27shop%27=%27cannabis%27](" + boundsJSON.minLat +"," + boundsJSON.minLng + "," + boundsJSON.maxLat + "," + boundsJSON.maxLng + ");out%20body;",
  };
